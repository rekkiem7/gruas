...
<tr><th width="80px">Rut:</th><td width="80px">14091305-7</td><th width="40px">Giro:</th><td width="360px">'.$OT[0]->OTRut.'</td><th width="70px">Telefono:</th><td width="90px">'.$OT[0]->OTTelefono.'</td></tr>
...
<tr><th width="140px">Llegada a bodega:</th><td width="130px">'.$OT[0]->ServicioHoraLlegadaG.'</td><th width="100px">Mas 19% iva:</th><td width="350px" colspan="3">CALCULAR</td></tr>
<tr><th width="140px">Total Horas:</th><td width="130px">CALCULAR</td><th width="100px">Total:</th><td width="350px" colspan="3">CALCULAR</td></tr>
<tr><td colspan="6" width="720px"></td></tr>
...
$pdf->Output('OrdenDeTrabajo_'.$OT[0]->OTNumero.'.pdf', 'D');
?>