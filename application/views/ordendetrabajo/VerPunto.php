...
else if (strlen($OT[0]->ServicioHoraSalidaG)==3)
{
	$OT[0]->ServicioHoraSalidaG = "0".$OT[0]->ServicioHoraSalidaG;	
}
...
else if (strlen($OT[0]->ServicioHoraLlegadaF)==3)
{
	$OT[0]->ServicioHoraLlegadaF = "0".$OT[0]->ServicioHoraLlegadaF;	
}
...
else if (strlen($OT[0]->ServicioHoraTerminoF)==3)
{
	$OT[0]->ServicioHoraTerminoF = "0".$OT[0]->ServicioHoraTerminoF;	
}
