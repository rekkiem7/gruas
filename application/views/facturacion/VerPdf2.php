...
class MYPDF extends TCPDF {
    ...
    public function Header(){
        ...
        $this->Image('imagenes/logoFactura2.png', 5, 5, 132, 25, '', '', '', false, 0, '', false, false, 0);
...
$pdf->AddPage();
if($modo==1){$tipo_factura="FACTURA ELECTRONICA";}else{$tipo_factura="FACTURA";}
$html='<table><tr><td width="65%"></td><td width="35%"><table width="250px" style="border:4px solid #CC0000;text-align:center;color:#CC0000"><tr><td style="padding-top:20px">R.U.T.: '.number_format(substr($info[0]->RazonSocial,0,-1),0,"",".").'-'.substr($info[0]->RazonSocial,strlen($info[0]->RazonSocial)-1,1).'<br>'.$tipo_factura.'<br>N°'.$info[0]->NumeroFactura.'</td></tr></table></td></tr></table>';
