...
function CalcularValores()
{
  ...
  else
  {
    ...
    HoraSalida           =   Number(HoraSalida.substring(0,2)*60) + Number(HoraSalida.substring(2,2));
    /*
    if(ServicioDesdeLas)
    {
    ...
    */
    if(HoraLlegada>1800 && $('#ServicioHR').val()) { HoraLlegada = "1800"; }
    var HoraTope           =   Number(HoraLlegada.substring(0,2)*60) + Number(HoraLlegada.substring(2,2));
    if(DescuentoColacion)
    {
      DescuentoColacion    =   Number(DescuentoColacion.substring(0,2)*60) + Number(DescuentoColacion.substring(2,2));
    }
    else
    {
      DescuentoColacion = 0;
