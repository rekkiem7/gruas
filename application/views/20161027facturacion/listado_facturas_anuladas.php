          ...
          $('#loading').modal('hide');
        	if(data!=0)
        	{
        		...
        		for(var i=0;i<datos.length;i++)
        		{
        			...
        			var info=[datos[i]['NumeroFactura'],ValidateRut(datos[i]['RutCliente']),datos[i]['nom_cliente'],"( "+datos[i]['RazonSocial']+" ) "+datos[i]['nom_razon'],datos[i]['TotalNeto'],descuento,datos[i]['IVA'],datos[i]['TotalFactura']];
