	  		...
	  		<br>
	    		<table width="100%">
					<tr>
						...
						<td width="40%" colspan="3"><input type="number" class="form-control" name="numerofactura" id="numerofactura"/></td>
						<td width="15%"></td>
						<td width="35%"></td>
					</tr>
	    			<tr>
